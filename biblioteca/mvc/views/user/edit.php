...
<html lang="es">
	...
	<div class="flex2 centered">	
		...
		<label for="displayname">Displayname</label>
			...
			<input type="number" min="0" name="telefono" value="<?=$user->telefono?>">
			<br>
		...
		<div class="flex2">
			<script src="/js/BigPicture.js"></script>
				...
				<img src="<?=USER_IMAGE_FOLDER.'/'.($user->picture ?? DEFAULT_USER_IMAGE)?>"
				 ...
				 <figcaption>Foto de perfil de <?= $user->nomdisplayname ?> </figcaption>
			...
			<a class="button" href="/User/show/<?=$user->id?>">Detalles</a>
					...
					<a class="button-danger" href='/socio/delete/<?=$user->id?>'>
