...
//Clase Vector...define 2 puntos X,Y inicial e X,Y final.
class Vector  {
    public $xi, $xf ; //Punto inicial
    public $yi,$yf ;  //Punto final
    public function __construct(float $xi=0, float $yi=0, float $xf=0, float $yf=0)
    {
        $this->xi = $xi;
        $this->yi = $yi;
        $this->xf = $xf;
...
//PRUEBAS Versión B: se debe retornar un nuevo vector y el original no debe quedar modificado.
echo "PRUEBAS VERSION B <br>";
$vB1=new Vector (0,1,2,3);
print_r("El vector original : ");
var_dump($vB1);
echo "<br>";

$vinv=invertirVectorB($vB1);
print_r("El vector original invertido  : ");
var_dump($vinv);
echo "<br>";
print_r("Quedando el vecor original : ");
var_dump($vB1);
echo "<br>";
