...
INSERT INTO usuarios (
	id, usuario , contrasena , nombre , apellido1, apellido2 , nif, sexo , email, fechanacimiento ,
    poblacion , direccion , pais ,   promociones )
VALUES
(1, 'jose','1234','Jose Miguel','Mora','Perez','39393939J','Hombre', jose@mitravel.com','2000-01-01','Terrassa','c/micasa 1','España',false),
(2, 'invitado','1234','Invitado','invitado','','11111111J','Hombre', invitado@mitravel.com','2000-01-01','Terrassa','c/micasa 1','España',true);
